...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#f955c22e#;
   ...
   u00007 : constant Version_32 := 16#6265e28a#;
   pragma Export (C, u00007, "ada__characters__wide_latin_1S");
   u00008 : constant Version_32 := 16#179d7d28#;
   pragma Export (C, u00008, "ada__containersS");
   ...
   u00043 : constant Version_32 := 16#ba03ad8f#;
   pragma Export (C, u00043, "ada__characters__handlingB");
   u00044 : constant Version_32 := 16#21df700b#;
   ...
   u00092 : constant Version_32 := 16#de53e0a3#;
   pragma Export (C, u00092, "ada__containers__helpersB");
   u00093 : constant Version_32 := 16#4adfc5eb#;
   pragma Export (C, u00093, "ada__containers__helpersS");
   ...
   u00116 : constant Version_32 := 16#60082284#;
   ...
   u00133 : constant Version_32 := 16#26aedc33#;
   pragma Export (C, u00133, "system__interrupt_managementS");
   u00134 : constant Version_32 := 16#7bca5a8d#;
   pragma Export (C, u00134, "system__multiprocessorsB");
   u00135 : constant Version_32 := 16#1756ce67#;
   pragma Export (C, u00135, "system__multiprocessorsS");
   u00136 : constant Version_32 := 16#24ec69e6#;
   pragma Export (C, u00136, "system__os_primitivesB");
   u00137 : constant Version_32 := 16#280734e2#;
   pragma Export (C, u00137, "system__os_primitivesS");
   u00138 : constant Version_32 := 16#2f9cb76c#;
   pragma Export (C, u00138, "system__arith_64B");
   u00139 : constant Version_32 := 16#9d9eabfb#;
   pragma Export (C, u00139, "system__arith_64S");
   u00140 : constant Version_32 := 16#05c60a38#;
   pragma Export (C, u00140, "system__task_lockB");
   u00141 : constant Version_32 := 16#4e70667a#;
   pragma Export (C, u00141, "system__task_lockS");
   u00142 : constant Version_32 := 16#b8c476a4#;
   pragma Export (C, u00142, "system__win32__extS");
   u00143 : constant Version_32 := 16#ce7dfb56#;
   pragma Export (C, u00143, "system__task_infoB");
   u00144 : constant Version_32 := 16#5a49699d#;
   pragma Export (C, u00144, "system__task_infoS");
   u00145 : constant Version_32 := 16#4ddebf0b#;
   pragma Export (C, u00145, "system__tasking__debugB");
   u00146 : constant Version_32 := 16#d3b35c55#;
   pragma Export (C, u00146, "system__tasking__debugS");
   ...
   u00152 : constant Version_32 := 16#8d63b971#;
   pragma Export (C, u00152, "system__stack_usageS");
   u00153 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00153, "ada__text_ioB");
   u00154 : constant Version_32 := 16#1eb2ee39#;
   pragma Export (C, u00154, "ada__text_ioS");
   u00155 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00155, "interfaces__c_streamsB");
   u00156 : constant Version_32 := 16#066a78a0#;
   ...
   u00161 : constant Version_32 := 16#2d4c7e6e#;
   pragma Export (C, u00161, "gnat__semaphoresB");
   u00162 : constant Version_32 := 16#03f45b79#;
   pragma Export (C, u00162, "gnat__semaphoresS");
   u00163 : constant Version_32 := 16#ac06ab59#;
   ...
   u00165 : constant Version_32 := 16#2e7731ce#;
   ...
   u00169 : constant Version_32 := 16#d5216b8e#;
   ...
   u00179 : constant Version_32 := 16#886988be#;
   pragma Export (C, u00179, "system__tasking__entry_callsB");
   u00180 : constant Version_32 := 16#526fb901#;
   ...
   u00197 : constant Version_32 := 16#0774605b#;
   pragma Export (C, u00197, "system__random_numbersB");
   u00198 : constant Version_32 := 16#19a1600c#;
   pragma Export (C, u00198, "system__random_numbersS");
   u00199 : constant Version_32 := 16#15692802#;
   pragma Export (C, u00199, "system__random_seedB");
   u00200 : constant Version_32 := 16#c3b30278#;
   pragma Export (C, u00200, "system__random_seedS");
   u00201 : constant Version_32 := 16#48583e4e#;
   pragma Export (C, u00201, "ada__calendarB");
   u00202 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00202, "ada__calendarS");
   u00203 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00203, "system__val_unsS");
   u00204 : constant Version_32 := 16#8e7c94d7#;
   pragma Export (C, u00204, "system__storage_pools__subpoolsB");
   u00205 : constant Version_32 := 16#8393ab70#;
   pragma Export (C, u00205, "system__storage_pools__subpoolsS");
   u00206 : constant Version_32 := 16#cafa918a#;
   pragma Export (C, u00206, "system__storage_pools__subpools__finalizationB");
   u00207 : constant Version_32 := 16#8bd8fdc9#;
   pragma Export (C, u00207, "system__storage_pools__subpools__finalizationS");
   u00208 : constant Version_32 := 16#c9a3fcbc#;
   pragma Export (C, u00208, "system__stream_attributesB");
   u00209 : constant Version_32 := 16#414158da#;
   pragma Export (C, u00209, "system__stream_attributesS");
   u00210 : constant Version_32 := 16#3e25f63c#;
   pragma Export (C, u00210, "system__stream_attributes__xdrB");
   u00211 : constant Version_32 := 16#ce9a2a0c#;
   pragma Export (C, u00211, "system__stream_attributes__xdrS");
   u00212 : constant Version_32 := 16#ecc88e78#;
   pragma Export (C, u00212, "system__fat_fltS");
   u00213 : constant Version_32 := 16#cafa8775#;
   pragma Export (C, u00213, "system__fat_lfltS");
   u00214 : constant Version_32 := 16#b02a299f#;
   pragma Export (C, u00214, "system__fat_llfS");
   u00215 : constant Version_32 := 16#75390335#;
   ...
   u00217 : constant Version_32 := 16#ead5bc8c#;
   pragma Export (C, u00217, "system__tasking__stagesB");
   u00218 : constant Version_32 := 16#6153a6f3#;
   pragma Export (C, u00218, "system__tasking__stagesS");
   u00219 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00219, "system__memoryB");
   u00220 : constant Version_32 := 16#76873720#;
